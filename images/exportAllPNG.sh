...
inkscape favorite_star_icon.svg --export-png ../app/src/main/res/drawable/favorite_star_icon.png -w 96 -h 96
inkscape rotate_default_icon.svg --export-png ../app/src/main/res/drawable/rotate_default_icon.png -w 96 -h 96
inkscape named_siteswaps_icon.svg --export-png ../app/src/main/res/drawable/named_siteswaps_icon.png -w 96 -h 96
